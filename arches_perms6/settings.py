"""
Django settings for arches_perms6 project.
"""
...
DATATYPE_LOCATIONS.append("arches_perms6.datatypes")
FUNCTION_LOCATIONS.append("arches_perms6.functions")
ETL_MODULE_LOCATIONS.append("arches_perms6.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_perms6.search_components")
...
SECRET_KEY = "django-insecure-qliqfv^^=29o$^6vk52^mx+bg5ynjw%g^5#e0%ly97$snbys+c"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "arches_perms6.urls"
ROOT_HOSTCONF = "arches_perms6.hosts"

DEFAULT_HOST = "arches_perms6"
...
ELASTICSEARCH_PREFIX = "arches_perms6"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_perms6.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_perms6",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_perms6.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_perms6"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_perms6.search.es_mapping_modifier.EsMappingModifier"]
